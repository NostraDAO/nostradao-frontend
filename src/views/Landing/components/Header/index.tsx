...
import "./header.scss";
import { ReactComponent as FedoraIcon } from "../../../../assets/icons/fedoraIcon.svg";
...
function Header() {
    ...
    return (
        <div className="landing-header">
            <SvgIcon color="primary" component={FedoraIcon} viewBox="0 0 174 40" style={{ minWidth: 174, minHeight: 40 }} />
